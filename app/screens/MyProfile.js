      ...
      await get_user_info(info.id)
        .then(async (response) => {
          ...
          if (response.data) {
            ...
            this.setState({
              car_picture:
                'http://149.28.78.240:5010/' + response.data.car_picture,
            });
            this.setState({
              license_front:
                'http://149.28.78.240:5010/' + response.data.license_front,
            });
            this.setState({
              license_back:
                'http://149.28.78.240:5010/' + response.data.license_back,
            });
          }
        })
        .catch((error) => {
          ...
          <View style={{padding: 20}}>
            ...
            {this.state.type == '0' ? (
              <View>
                ...
                {this.state.car_picture ? (
                  <Image
                    source={{uri: this.state.car_picture}}
                ...
                <Text>{strings('driver.liceFront')}</Text>
                {this.state.license_front ? (
                  <Image
                    source={{uri: this.state.license_front}}
                    style={{width: 150, height: 150, marginTop: 5}}
                    resizeMode="contain"
                    resizeMethod="resize"
                  />
                ...
                <Text>{strings('driver.liceBack')}</Text>
                {this.state.license_back ? (
                  <Image
                    source={{uri: this.state.license_back}}
                    style={{width: 150, height: 150, marginTop: 5}}
                    resizeMode="contain"
                    resizeMethod="resize"
                  />
